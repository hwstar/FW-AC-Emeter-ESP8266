...
#define KVS_BLOB_SIZE (KVS_ENTRY_SIZE - KVS_MAX_KEY)
...
bool kvstore_dirty(flash_handle_s *h);
void *kvstore_get_blob(flash_handle_s *h, const char *key);
...
bool kvstore_put_blob(flash_handle_s *h, const char *key, const void *blob);
